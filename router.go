...
type Handle func(http.ResponseWriter, *http.Request, *Leaf, Params)
...
func (r *Router) Handle(method string, pattern string, handlers []Handler) *Route {
	...
	return r.handle(method, pattern, func(resp http.ResponseWriter, req *http.Request, route *Leaf, params Params) {
