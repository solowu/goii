...
import (
	...
	"errors"
	"fmt"
	"github.com/solowu/goii/mod/container/gvar"
	"github.com/solowu/goii/mod/os/gcache"
	"github.com/solowu/goii/mod/os/gtime"
	"github.com/solowu/goii/mod/text/gregex"
...
func (bs *dbBase) rowsToResult(rows *sql.Rows) (Result, error) {
	...
	for rows.Next() {
		...
		for i, col := range values {
			//   fmt.Println(columns[i],types[i],col)
			if col == nil {
